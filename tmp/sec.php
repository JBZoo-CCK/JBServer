...
<div class="application">
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <select name="app_audit_level">
            <option
                value="common"<?php if ($_POST && array_key_exists('app_audit_level', $_POST) && $_POST['app_audit_level'] == 'common') echo ' selected="selected"'; ?>><?php echo APP_LABEL_COMMON; ?></option>
            <option
                value="shared"<?php if ($_POST && array_key_exists('app_audit_level', $_POST) && $_POST['app_audit_level'] == 'shared') echo ' selected="selected"'; ?>><?php echo APP_LABEL_SHARED; ?></option>
            <option
                value="paranoid"<?php if ($_POST && array_key_exists('app_audit_level', $_POST) && $_POST['app_audit_level'] == 'paranoid') echo ' selected="selected"'; ?>><?php echo APP_LABEL_PARANOID; ?></option>
        </select>
